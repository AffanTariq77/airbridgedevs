...
const Hero = () => {
  return (
    <Dialog>
      <section className="pt-24 md:pt-32 pb-10 px-4 md:px-8 bg-gradient-to-b from-background to-muted/20">
        <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12 md:gap-20">
          ...
          <div className="flex-1 w-full text-left space-y-7 max-w-2xl md:pr-8">
            ...
            <p className="text-lg md:text-2xl text-muted-foreground max-w-xl md:max-w-2xl">
